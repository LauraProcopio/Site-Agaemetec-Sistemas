...
const About = () => (
  <section id="about" className="py-16 bg-white">
    <div className="container mx-auto grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-8 items-center">
      <div>
      ...
      <div className="w-full">
        <img src="/img/logo_agaemetec.png" alt="Logo Agamemtec" className="w-full h-auto object-contain" />
      </div>
    </div>
  </section>
);
